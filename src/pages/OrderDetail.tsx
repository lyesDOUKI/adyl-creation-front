      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <Card className="p-8 text-center space-y-4 max-w-md">
            ...
            <Button onClick={() => navigate('/suivi')}>Voir toutes les commandes</Button>
          </Card>
        </div>
        <Footer />
      </div>
      ...
      <main className="flex-1 container py-8 max-w-3xl animate-fade-in">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Passée le {order.createdAt.toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' })}
            </p>
          </div>
          <Button variant="outline" size="sm" onClick={() => downloadOrderInvoice(order)}>
        ...
        <div className="grid md:grid-cols-[1fr_280px] gap-6">
          ...
          <div className="space-y-6">
            {/* Timeline */}
            <Card className="p-6">
              <h2 className="font-heading font-bold text-lg mb-5">Suivi de la commande</h2>
              <OrderTimeline steps={order.steps} />
            </Card>

            {/* Items */}
            <Card className="p-6">
              <h2 className="font-heading font-bold text-lg mb-4">Articles commandés</h2>
